...
class VehicleTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var gvwr: UILabel!
    ...
    override func awakeFromNib() {
        ...
        gcwr.font = UIFont(name: "Roboto-Medium", size: 18)
        gvwr.font = UIFont(name: "Roboto-Medium", size: 18)
        mcc.font = UIFont(name: "Roboto-Medium", size: 18)
        vin.font = UIFont(name: "Roboto-Medium", size: 12)
