...
class UISlidingTabController: UIViewController {
    ...
    private var heightHeader = 40
    var delegate: SlidingTabDelegate?
    ...
    func build(){
        ...
        collectionPage.backgroundColor = .gray
        collectionPage.scrollIndicatorInsets = UIEdgeInsets(top: 0, left: 0, bottom: 0, right: 0)
        collectionPage.contentInset = UIEdgeInsets(top: 0, left: 0, bottom: 0, right: 0)
...
extension UISlidingTabController: UICollectionViewDelegate{
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        self.delegate?.didSelectTab(tab: indexPath.row)
        NotificationCenter.default.post(name: Notification.Name("tabPress"), object: nil, userInfo:["tab": indexPath.row])
    }
...
extension UISlidingTabController: UICollectionViewDelegateFlowLayout{
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        return CGSize(width: view.frame.size.width, height: view.frame.size.height - CGFloat(heightHeader))
